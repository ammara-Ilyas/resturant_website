            ...
            {currentItems &&
              currentItems.map((item, index) => (
                <div
                  ...
                  } flex items-center pt-4 group font-sans letter-wide shadow-lg `}
                >
                  <div
                    className={`border-2 ${
                      isGrid === "grid"
                        ? " h-[260px] w-[260px]"
                        : " h-[160px] w-[160px]"
                    } border-orange-600 -rotate-12 group-hover:rotate-0 group-hover:scale-105 duration-300 transition-transform ease-in-out p-2 `}
